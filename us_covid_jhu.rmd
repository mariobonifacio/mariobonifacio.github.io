...
```{r}
orig_data <- data.table(read_csv("https://github.com/mariobonifacio/COVID-19/blob/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_US.csv?raw=true"))
...
```{r}
orig_case_data <- data.table(read_csv("https://github.com/CSSEGISandData/COVID-19/blob/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_US.csv?raw=true"))
...
```{r}
write.csv(x = wk_data, file = "wk_data.csv")
```
