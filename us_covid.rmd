  ...
  ,wk_ending := case_when(wday(ymd(date)) == wday(data_date) ~ ymd(date),
                          ...
                          TRUE ~ ymd(date) + days(7 + wday(data_date) - wday(ymd(date))))][
                            ,c("hospitalizedCurrently",
                               ...
                               "deathIncrease",
                               "hospitalizedIncrease") := list(mean(hospitalizedCurrently, na.rm = TRUE),
                                                               mean(inIcuCurrently, na.rm = TRUE),
                                                               mean(onVentilatorCurrently, na.rm = TRUE),
                                                               ...
                                                               sum(hospitalizedIncrease, na.rm = TRUE)),
...
```{r}
coeff_tbl <- data.table(state = static_data[,state])[est_casepos_case(test_tbl = clean_data[, c("lead3_wk_ending", "lead3_deathIncrease")])]
```
