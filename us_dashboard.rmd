...
coeff_2_table <- data.table(code = character(), coeff_pos_rate = double())



for (j in code_names[,code]) { lm(data = cor_data[code == j,list(as_of, code, case_ch, as_of_lag_1wk, pos_rate_lag_1wk)],
                                  formula = case_ch ~ 0 + pos_rate_lag_1wk)[1][1]
