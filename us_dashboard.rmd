...
lifetime_data %>% 
  ...
  labs(x = "Date", y = "New cases per million per week", title = "U.S. cases are 200% higher than ever and CA's are double that number", subtitle = str_c("Through ", max(lifetime_data$as_of)))
...
weekly_data %>% 
  ...
  theme_bw() +
  theme(legend.title = element_blank()) +
  labs(x = "Date", y = "cases per million per week", title = "California spread across the country", subtitle = str_c("Week ending ", max(weekly_data$wk_ending))) +
  scale_fill_brewer(palette="Dark2")
