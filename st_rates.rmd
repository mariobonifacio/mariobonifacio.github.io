...
my_data %>% 
  ...
  theme(legend.position = "none") +
  labs(title = str_c("It appears as though", pk, "cases are neither plateauing, let alone dropping", sep = " "), subtitle = str_c("Cases per day since", min(my_data[death_ch > 9 & code == 'OK', as_of]), sep = " "), x = NULL, y = "New COVID-19 cases by day", caption = "The vertical, dashed blue line marks the President's 21 June rally in Tulsa") +
  scale_alpha(range = c(.1, .3))
```
