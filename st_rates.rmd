...
my_data %>% 
  ...
  labs(title = "How did new cases change when CDC stopped reporting on 16 July?", subtitle = "New U.S. cases per day since 1 July", x = NULL, y = "COVID-19 daily cases")
```
