...
# cor_data %>%
#     group_by(code) %>% 
#     mutate(death_ch_proj = lm("death_ch_lead_3wk ~ case_ch + pos_rate_4wk", ., na.action = na.omit[[1]][[1]] +
#              case_ch * lm("death_ch_lead_3wk ~ case_ch + pos_rate_lag_1wk", ., na.action = na.omit)[[1]][[2]] +
#              pos_rate_lag_1wk * lm("death_ch_lead_3wk ~ case_ch + pos_rate_lag_1wk", ., na.action = na.omit)[[1]][[3]]))
...
# lm(data = cor_data, formula = death_ch ~ case_ch * pos_rate)[[1]][[1]]
# lm(data = cor_data, formula = death_ch ~ case_ch  / pos_rate)[[1]][[2]]
# 
# 
# j <- data.table(code = character(),
#                 d_offset = integer(),
#                 cor_offset = double(),
#                 cfr = double(),
#                 pos_rate = double())
