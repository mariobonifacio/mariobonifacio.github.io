...
my_data %>% 
  ...
  labs(title = str_c(str_c(pk, collapse = ", "), " infection rate has been lower since May", sep = ""), subtitle = "New daily cases per million residents, split by state", x = "date", y = "new daily COVID-19 cases per million residents", caption = "The Sturgis Motorcycle Rally is marked at 16 Aug") +
  ggthemes::theme_hc() +
  theme(legend.title = element_blank())
