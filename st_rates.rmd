...
my_data %>% 
  ...
  labs(x = "Date", y = "New COVID-19 cases per million per day", title = "States Trump won have had higher daily new COVID-19 cases since June", subtitle = "Total new COVID-19 cases per million per day by 2016 result") +
  theme(
