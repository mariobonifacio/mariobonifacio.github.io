...
my_data %>% 
  ...
  labs(subtitle = str_c("Top 3 states in per capita COVID-19 deaths each week, through ", max(my_data$as_of, na.rm = TRUE), sep = " "),
       title = "States Trump won in 2016 have led in deaths per capita since June",
...
my_data %>% 
  ...
  # theme(legend.position = "none") +
  labs(subtitle = str_c("Three states with most weekly per capita COVID-19 deathsthrough", max(my_data$as_of, na.rm = TRUE), sep = " "),
       y = "Weekly COVID-19 deaths per million residents",
       x = "Date",
       fill = "pop. per\nsq. mi.") +
  xlim(ymd(20200301), today()) +
