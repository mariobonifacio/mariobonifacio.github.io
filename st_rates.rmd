...
my_data %>% 
  ...
  theme(legend.position = "none") +
  labs(title = str_c("Are new", pk,"cases plateauing or even dropping?", sep = " "), subtitle = "New cases per day since 1 death per million", x = "date", y = "New COVID-19 cases per day")
```
